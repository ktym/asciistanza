...
async function barchart(stanza, params) {
  ...
  let scale = linear().domain(extent(values)).range(range).nice();
...
var metadata = {
	...
	"stanza:definition": "ASCII Barchart",
	"stanza:type": "Stanza",
	"stanza:display": "Text",
	...
	"stanza:created": "2021-04-26",
	"stanza:updated": "2021-04-26",
	"stanza:parameter": [
	{
		"stanza:key": "data-url",
	...
	},
	{
		...
		"stanza:description": "Variable to be assigned as a category",
		"stanza:required": true
	},
	{
		"stanza:key": "value",
		"stanza:example": "count",
		"stanza:description": "Variable to be assigned as a value",
		"stanza:required": true
	},
	{
		"stanza:key": "group-by",
		"stanza:example": "category",
		"stanza:description": "Variable to be assigned as a group",
		"stanza:required": false
	},
	{
		"stanza:key": "max-label-length",
		"stanza:example": 10,
		"stanza:description": "Maximum label length of the category name",
		"stanza:required": false
	},
	{
		"stanza:key": "max-bar-length",
		"stanza:example": 50,
		"stanza:description": "Maximum bar length in the number of letters",
		"stanza:required": false
	}
],
	...
	{
		"stanza:key": "--togostanza-line-height",
		"stanza:type": "number",
		"stanza:default": 1,
		"stanza:description": "Line height"
	},
	{
...
var templates = [
  ...
  return "<pre>\n"
    + container.escapeExpression(((helper = (helper = lookupProperty(helpers,"graph") || (depth0 != null ? lookupProperty(depth0,"graph") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"graph","hash":{},"data":data,"loc":{"start":{"line":2,"column":0},"end":{"line":2,"column":9}}}) : helper)))
    + "\n</pre>\n";
},"useData":true}]
];
